...
11. Convert the programs in [flow of program](flow-of-program Assignment), [first java](first-java Assignment), [conditionals & loops](conditionals-loops Assignments) assignments into functions.
